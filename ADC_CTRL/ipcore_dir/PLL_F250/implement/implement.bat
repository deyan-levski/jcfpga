...
xst -ifn xst.scr
move PLL_F250_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_F250_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_F250_exdes.ucf PLL_F250_exdes

echo 'Running map'
map -timing -pr b PLL_F250_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PLL_F250_exdes -w routed.ncd routed.vhd
cd ..
