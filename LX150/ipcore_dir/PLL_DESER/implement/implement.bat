...
xst -ifn xst.scr
move PLL_DESER_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_DESER_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_DESER_exdes.ucf PLL_DESER_exdes

echo 'Running map'
map -timing -pr b PLL_DESER_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PLL_DESER_exdes -w routed.ncd routed.vhd
cd ..
