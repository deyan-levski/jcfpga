...
xst -ifn xst.scr
move PLL_FX3_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\PLL_FX3_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc PLL_FX3_exdes.ucf PLL_FX3_exdes

echo 'Running map'
map -timing -pr b PLL_FX3_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm PLL_FX3_exdes -w routed.ncd routed.vhd
cd ..
